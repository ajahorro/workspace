-- ==========================================
-- FIX: AGGRESSIVE UUID SANITIZATION
-- Resolving "invalid input syntax for type uuid" using regex stripping
-- ==========================================
...
BEGIN
  ...
  LOOP
    ...
    -- AGGRESSIVE FIX: Strip all non-uuid characters before casting
